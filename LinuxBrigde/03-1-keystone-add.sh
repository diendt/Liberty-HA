...
ops_edit $filekeystone DEFAULT public_bind_host $VIP
ops_edit $filekeystone DEFAULT admin_bind_host $VIP
...
test -f /root/admin-openrc.sh || cp  /root/ha-lb/admin-openrc.sh /root/admin-openrc.sh
...
test -f /root/demo-openrc.sh || cp  /root/ha-lb/demo-openrc.sh /root/demo-openrc.sh
